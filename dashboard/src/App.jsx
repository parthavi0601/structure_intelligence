      ...
      {loading ? (
        ...
        <main className="dashboard-content">
          ...
          <div className="metrics-grid">
            ...
            <div className="metric-card glass-panel">
              <div className="metric-header">Anomaly Alert Status</div>
              <div className="metric-value state-value">
                {latestMetrics?.Anomaly_Alert_Flag ? <span className="badge state-danger"><AlertTriangle size={14}/> ALERT</span> : <span className="badge state-normal"><CheckCircle size={14}/> CLEAR</span>}
              </div>
          ...
          <div className="charts-grid">
            ...
            <div className="chart-panel glass-panel" style={{ gridColumn: '1 / -1' }}>
              <div className="panel-header">
                <h2>Autoencoder Reconstruction Error (Anomaly Score)</h2>
              ...
              <div className="chart-wrapper">
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={metrics} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    ...
                    />
                    <Area type="monotone" dataKey="Autoencoder_Anomaly_Score" stroke="#EF4444" strokeWidth={3} fillOpacity={1} fill="url(#colorAnomaly)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
